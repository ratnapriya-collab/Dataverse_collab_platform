...
const TABS: TabSpec[] = [
  { id: 'overview', label: 'Overviews', icon: LayoutDashboard },
  { id: 'decisions', label: 'Tasks', icon: ClipboardList },
  { id: 'feedback', label: 'Discussions', icon: MessageSquare },
