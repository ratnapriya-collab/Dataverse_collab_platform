...
export const SEED_FULL_DECISIONS: MockFullDecision[] = [
  ...
  // ── More demo_1 decisions — density test for the viewer pin field ─────
  {
    id: 'DEC-TURBO-V3-12',
    project_id: 'proj_turbo',
    project_name: 'Turbocharger Compressor Housing V3',
    part_id: 'demo_1',
    part_name: 'Compressor Housing v2',
    anchor_id: 'face-volute-3',
    state: 'PROPOSED',
    rationale:
      'Volute exit-radius transition has a sharp inside corner that stress-concentrates under hot soak (FEA showed 312 MPa peak). Recommend R2.0 mm fillet.',
    author_name: 'Sarah Chen',
    author_team: 'CAE',
    citations: ['ISO 1101', 'FEA-RUN-2026-04-21'],
    created_at: new Date(NOW - 18 * 3_600_000).toISOString(),
    title: 'Sharp inside corner at volute exit (R2.0 mm fillet)',
    tags: ['DFM', 'Complexity: Medium'],
    priority: 'high',
    assignee_name: 'David Kim',
  },
  {
    ...
    part_id: 'demo_1',
    part_name: 'Compressor Housing v2',
    anchor_id: 'face-impeller-rim-2',
    state: 'PROPOSED',
    rationale:
      'Impeller-rim shroud clearance specified as 0.4 mm — supplier reports their casting tolerance band is ±0.25 mm. Re-spec to 0.6 mm to maintain margin.',
    author_name: 'John Williams',
    author_team: 'SUPPLIER',
    citations: ['DRW-TURBO-V3-A2', 'ASME Y14.5 §4.2'],
    created_at: new Date(NOW - 3 * 3_600_000).toISOString(),
    title: 'Impeller-rim shroud clearance vs. supplier tolerance band',
    tags: ['Tolerancing', 'Sourcing'],
    priority: 'medium',
    assignee_name: 'Sarah Chen',
  },
  {
    ...
    part_id: 'demo_1',
    part_name: 'Compressor Housing v2',
    anchor_id: 'face-mount-pad-N',
    state: 'ACCEPTED',
    rationale:
      'Mounting-pad flatness tightened from 0.10 mm to 0.05 mm to match the engine-block face. Surface-finish callout added (Ra 0.8).',
    author_name: 'David Kim',
    author_team: 'MANUFACTURING',
    citations: ['ISO 1101', 'GD&T-PRO-7'],
    created_at: new Date(NOW - 5 * DAYS).toISOString(),
    title: 'Mounting-pad flatness 0.05 mm + Ra 0.8',
    tags: ['Manufacturing', 'Tolerancing'],
    priority: 'medium',
  },
  {
    id: 'DEC-TURBO-V3-15',
    ...
    part_id: 'demo_1',
    part_name: 'Compressor Housing v2',
    anchor_id: 'face-flange-2',
    state: 'PROPOSED',
    rationale:
      'Discharge flange bolt-pattern hole-Ø in current rev is 8.5 mm; standard fastener is M8 (clearance 8.4 mm typ). Tighten to 8.4 +0.1/-0 mm.',
    author_name: 'Maria Garcia',
    author_team: 'REVIEWER',
    citations: ['ISO 273', 'ASME Y14.5'],
    created_at: new Date(NOW - 7 * 3_600_000).toISOString(),
    title: 'Discharge flange bolt-Ø 8.5 → 8.4 +0.1/-0 mm',
    tags: ['Tolerancing'],
    priority: 'medium',
  ...
  },
  {
    ...
    part_id: 'demo_1',
    part_name: 'Compressor Housing v2',
    anchor_id: 'face-rib-vertical-4',
    state: 'PROPOSED',
    rationale:
      'Vertical stiffening rib has a 1.5 mm draft on the parting-line side. Tooling vendor needs ≥ 3° draft for clean release — modify to 3°.',
    author_name: 'John Williams',
    author_team: 'SUPPLIER',
    citations: ['DFM-CAST-04', 'Tool-Q-2026-031'],
    created_at: new Date(NOW - 14 * 3_600_000).toISOString(),
    title: 'Stiffening rib draft 1.5° → 3°',
  ...
  },
  {
    ...
    part_id: 'demo_1',
    part_name: 'Compressor Housing v2',
    anchor_id: 'face-coolant-port',
    state: 'ACCEPTED',
    rationale:
      'Coolant-port thread spec updated to G1/4 BSPP per OEM standard. O-ring groove added to match seal ring 9911.',
    author_name: 'Sarah Chen',
    author_team: 'CAE',
    citations: ['ISO 228-1', 'GASKET-DS-9911'],
    created_at: new Date(NOW - 4 * DAYS).toISOString(),
    title: 'Coolant port → G1/4 BSPP + O-ring groove',
    tags: ['Materials', 'Manufacturing'],
    priority: 'low',
  },
  {
    id: 'DEC-TURBO-V3-18',
    ...
    part_id: 'demo_1',
    part_name: 'Compressor Housing v2',
    anchor_id: 'face-inlet-cone-1',
    state: 'PROPOSED',
    rationale:
      'Inlet cone surface waviness measured on first article exceeds 4 µm peak-to-valley; spec is 2 µm. Re-check toolpath stepover.',
    author_name: 'Maria Garcia',
    author_team: 'REVIEWER',
    citations: ['ISO 4287'],
    created_at: new Date(NOW - 50 * 60_000).toISOString(),
    title: 'Inlet cone waviness 4 µm vs. 2 µm spec',
    tags: ['Manufacturing', 'Machining'],
    priority: 'high',
    assignee_name: 'David Kim',
  },
  {
    ...
    part_id: 'demo_1',
    part_name: 'Compressor Housing v2',
    anchor_id: 'face-snout-3',
    state: 'PROPOSED',
    rationale:
      'Snout wall thickness at Z-section -45 mm reads 1.4 mm in CAE — below the 2.0 mm minimum. Same root cause as DEC-TURBO-V3-11 (cast-pull direction).',
    author_name: 'Sarah Chen',
    author_team: 'CAE',
    citations: ['AS9100 §6.4.3', 'DEC-TURBO-V3-11'],
    created_at: new Date(NOW - 38 * 60_000).toISOString(),
    title: 'Snout wall thickness 1.4 mm at Z-45',
    tags: ['DFM', 'Blocker'],
    priority: 'blocker',
    assignee_name: 'Naga Reddy',
  },
  {
    ...
    part_id: 'demo_1',
    part_name: 'Compressor Housing v2',
    anchor_id: 'face-shroud-inner-1',
    state: 'ACCEPTED',
    rationale:
      'Shroud inner radius profile smoothed from polyline to spline (3-tangent fit). Confirmed compatible with 5-axis tool reach.',
    author_name: 'David Kim',
    author_team: 'MANUFACTURING',
    citations: [],
    created_at: new Date(NOW - 6 * DAYS).toISOString(),
    title: 'Shroud inner profile: polyline → spline',
    tags: ['Manufacturing'],
    priority: 'low',
  },
  {
    ...
    part_id: 'demo_1',
    part_name: 'Compressor Housing v2',
    anchor_id: 'face-bolt-boss-A',
    state: 'PROPOSED',
    rationale:
      'Bolt-boss A torque-up creates a hot-spot at the boss-to-shell fillet under thermal cycling. Suggest adding a 2 mm relief groove.',
    author_name: 'Sarah Chen',
    author_team: 'CAE',
    citations: ['Thermal-Run-2026-04-18'],
    created_at: new Date(NOW - 11 * 3_600_000).toISOString(),
    title: 'Bolt-boss A thermal hot-spot — add relief groove',
    tags: ['DFM', 'Complexity: Medium'],
    priority: 'medium',
    assignee_name: 'Maria Garcia',
  },
  {
    ...
    part_id: 'demo_1',
    part_name: 'Compressor Housing v2',
    anchor_id: 'face-vent-slot-2',
    state: 'PROPOSED',
    rationale:
      'Vent slot length increased from 8 mm to 12 mm per CFD recommendation — pressure-drop drops from 4.1 kPa to 2.6 kPa at peak flow.',
    author_name: 'Sarah Chen',
    author_team: 'CAE',
    citations: ['CFD-RUN-2026-04-23'],
    created_at: new Date(NOW - 2 * DAYS).toISOString(),
    title: 'Vent slot 8 → 12 mm (CFD optimisation)',
    tags: ['DFM', 'VAVE'],
    priority: 'low',
  },
  {
    ...
    part_id: 'demo_1',
    part_name: 'Compressor Housing v2',
    anchor_id: 'face-drain-port',
    state: 'REJECTED',
    rationale:
      'Original proposal to relocate the drain port to the underside was rejected — service-access required from above per OEM service spec.',
    author_name: 'John Williams',
    author_team: 'SUPPLIER',
    citations: ['OEM-SERVICE-MANUAL §3.2'],
    created_at: new Date(NOW - 8 * DAYS).toISOString(),
    title: 'Drain port relocation — rejected (service access)',
    tags: ['Manufacturing'],
    priority: 'low',
  },
  {
