...
export default function ExportButton({ totalCount, visibleCount }: Props): JSX.Element {
  ...
  // Always clickable — the dialog itself handles the empty-state, and
  // disabling here made users think the app was broken when threads
  // hadn't yet hydrated from decisions.
  void totalCount
